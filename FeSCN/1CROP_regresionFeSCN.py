...
#prueba de recorte intereactivo + funcion para color promedio + regresion lineal (casi completo) para cianuro de hierro
...
#Concentracion, elegir para Rojo metilo o Cianuro de hierro
x=[2*10**-5,4*10**-5,6*10**-5,8*10**-5,10*10**-5]
...
print(" El coeficiente de determinación para rojo es R^2 = ", r2 := reg0.score(x, r)) #operador walrus
...
print(" El coeficiente de determinación para verde es R^2 = ", r2 := reg1.score(x, g))
...
print(" El coeficiente de determinación para azul es R^2 = ", r2 := reg2.score(x, b))
...
plt.title("Curvas de calibración RGB vs Concentración FeSCN",fontsize=12, fontweight="bold")
plt.legend(["Regresión lineal Rojo","Regresión lineal Verde","Regresión lineal Azul",
            "Datos Rojo","Datos Verde","Datos Azul"], loc='best')
plt.savefig("FeSCN_regresionCROP.jpg")
plt.show()