...
#prueba de recorte intereactivo + funcion para color promedio + regresion lineal (casi completo) para rojo metilo
...
plt.title("Curvas de calibración RGB vs Concentración Rojo Metilo",fontsize=12, fontweight="bold")
plt.savefig("RojoMetilo_regresionCROP.jpg")
plt.show()