...
#24/10/25 es la ultima actualizacion

# Prueba de recorte interactivo con 3 cuadrados + función para color promedio + regresión lineal
...
plt.title("Curvas de calibración RGB vs Concentración Rojo Metilo", fontsize=13, fontweight='bold')
